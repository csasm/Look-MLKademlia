...
class Lookupconverge_ext(wx.Frame):
    ...
    def __init__(self, parent, mytitle, data_list, Size):
    ...
    def create_controls(self):
        ...
        self.toolbar.AddLabelTool(1, "Play/Pause",
            wx.Bitmap('images/playpause.png'))
